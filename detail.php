        ...
        <section class="container my-5">
            ...
            <section class="row">
                <section class="col-md-12">
                    ...
                    $query = "SELECT posts.* , categories.name As category_name FROM php_project.posts 
                    JOIN categories ON posts.cat_id = categories.id WHERE posts.status = 10 AND  posts.id = ?;";
